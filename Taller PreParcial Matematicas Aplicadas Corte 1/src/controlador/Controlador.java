...
public class Controlador {
	...
	private void ejercicio1() { // Ejercicio de número aleatorio con congruencia lineal

	}

	private void ejercicio2() { // Ejercicio de número aleatorio con Método de Montecarlo
		...
		for (int i = 0; i < puntosTotales; i++) {
			x = (float) (Math.random()); // Número aleatorio para x entre 0 y 1
			aleatorio = (float) (Math.random() * 3); // Número aleatorio
			modelo_2.setX(x);
		...
		float areaBajoCurva = puntosDentro / puntosTotales;
	...
	private void ejercicio3() { // Ejercicio de número primo Criba de Eratóstenes

	}

	private void ejercicio4() { // Ejercicio áritmética modular con fecha

	}

	private void ejercicio5() { // Ejercicio aritmética modular cifrado cesar
